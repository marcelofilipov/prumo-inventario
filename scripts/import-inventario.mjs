...
const REGRAS_CATEGORIA = [
  {
    ...
    palavras: [
      ...
      'TRONO', 'ESQUIFE', 'PEDRA BRUTA', 'PEDRA POLIDA', 'CASTIÇAL', 'CASTICAL', 'VELAS ', 'ESPADA',
      'FERRAMENTAS SIMBÓLICAS', 'FERRAMENTAS SIMBOLICAS', 'PENTÁGONO', 'PENTAGONO', 'TURÍBULO', 'TURIBULO',
      'ESCRUTINIO', 'CAMARA DE REFLEXÃO', 'CAMARAS DE REFLEXÃO', 'CAMARA DE REFLEXAO', 'PÚPITO', 'PUPITO',
      'ESTANDARTE', 'MANCEBO', 'COLUNETA', 'VITRAUX', 'BODE EMBALSAMADO', 'PROPOSTA E TRONCO',
      'NICHO PARA BANDEIRA', 'NICHO PARA ESTANDARTE', 'SUPORTE PARA PIRA', 'SUPORTE DE MADEIRA PARA ESTRELAS',
      'ESTRELAS C/ LÂMPADAS', 'ESTRELAS C/ LAMPADAS',
    ],
  },
  {
    categoria: 'acessibilidade_saude',
    palavras: [
      'MEDICAMENTO', 'FARMÁCIA', 'FARMACIA', 'CADEIRA DE BANHO', 'CADEIRA DE RODAS', 'ANDADOR', 'MULETA',
      'SUPORTE PARA SORO', 'RAMPA COM CAVALETE',
    ],
  },
  {
    ...
    palavras: [
      ...
      'PROJETOR', 'DATASHOW', 'MICROFONE', 'CAIXA DE SOM', 'CAIXA ACUSTICA', 'CAIXA ACÚSTICA', 'RÁDIO', 'RADIO',
      'GELADEIRA', 'FREEZER', 'MICRO-ONDAS', 'MICROONDAS', 'VENTILADOR', 'BEBEDOURO', 'CÂMERA', 'CAMERA',
      'MONITOR', 'NOTEBOOK', 'INTERFONE', 'INTERONE', 'CONTROLE REMOTO', 'LAMPADA', 'LÂMPADA', 'LUMINÁRIA',
      'LUMINARIA', 'LUSTRE', 'LUZ DE EMERGÊNCIA', 'LUZ DE EMERGENCIA', 'LUZES DE EMERGÊNCIA', 'SPOT',
      'REFLETOR', 'PILHA', 'PEN DRIVE', 'FONE DE OUVIDO', 'LANTERNA', 'ESTABILIZADOR DE VOLTAGEM',
      'EXTENSÃO COM CABO', 'CABOS DIVERSOS', 'TOMADA COMPLETA', 'TELÃO', 'TELAO', 'CD PLAYER', 'DISC MAN',
      'PORTEIRO ELETR', 'MEGAFONE', 'EQUALIZADOR',
    ],
  },
  {
  ...
  },
  {
    ...
    palavras: [
      ...
      'COZINHA', 'AMASSADOR', 'ABRIDOR', 'AMOLADOR', 'BAIXELA', 'BULE', 'CALDEIRÃO', 'CALDEIRAO', 'CANECA',
      'CANECO', 'CONCHA', 'ESCORREDOR', 'ESCUMADEIRA', 'ESPÁTULA', 'ESPATULA', 'ESPETO', 'ESPREMEDOR',
      'GRELHA', 'GARRAFA TÉRMICA', 'GARRAFA TERMICA', 'LEITEIRA', 'MOLHEIRA', 'MULTIPROCESSADOR', 'MIXER',
      'PALITEIRO', 'PEGADOR', 'PENEIRA', 'PIRES', 'PIREX', 'POTE DE', 'RALADOR', 'SACA ROLHA', 'SALADEIRA',
      'SALEIRO', 'TAÇA', 'TACHO', 'TABUA', 'TABUAS', 'TOALHA', 'CHAPEU DE MESTRE CUCA', 'CUTELO',
      'DESCASCADOR', 'CORTADOR DE BATATA', 'FORNO DE PIZZA', 'FRITADOR', 'FUNIL', 'FURADOR DE COCO',
      'INJETOR DE TEMPERO', 'LUVAS DE COZINHEIRO', 'MAQUINA DE CORTAR FRIOS', 'COIFA', 'BISNAGA',
      'CILINDRO DE GÁS', 'CILINDRO DE GAS', 'GUARDANAPO', 'SUPORTE BANHO MARIA', 'SUPORTE DE FILTRO DE CAFÉ',
      'SUPORTE DE ALUMINIO PARA COADOR', 'SUPORTE PLASTICO PARA COADOR', 'SUPORTE PLASTICO PARA RALADOR',
    ],
  },
  {
    ...
    palavras: [
      ...
      'BALCAO', 'BANCO', 'BANQUETA', 'ESPELHO', 'GLOBO DE VIDRO', 'PERSIANA', 'VASO', 'RELOGIO DE PAREDE',
      'RELÓGIO DE PAREDE', 'SABONETEIRA', 'TOALHEIRO', 'PAPELEIRA', 'PORTA PAPEL DE PAREDE', 'TRIPÉ', 'TRIPE',
      'GAVETEIRO', 'GABINETE DE MADEIRA', 'ESCANINHOS', 'NICHO DE MADEIRA', 'CONSOLE DE MADEIRA', 'COLCHONETE',
    ],
  },
]
